...
cadastrar_livro:
	...
	la $s1, quantidade  # Recarrega o endereco de quantidade novamente (para voltar ao primeiro caractere)
...
converter_quantidade_para_inteiro:	
	...
	lw $ra, 0($sp) # retorna para registrar_emprestimo (OH ASESEMBLY, FAÇA ISSO IR VOLTAR PARA REGISTRAR_EMPRESTIMO)
	jr $ra
...
registrar_devolucao:
	...
	# Imprime uma mensagem de que a devolucao foi conclu�da no display
